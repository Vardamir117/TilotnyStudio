...
namespace Holocron
{
    public partial class SubmodSetup : Form
    {
        ...
        private void FoCButton_Click(object sender, EventArgs e)
        {
            Args.Add(Path.Combine(UpOneFolder(localmodpath), "Data"));
            Args.Add(Path.Combine(UpOneFolder(UpOneFolder(localmodpath)), "GameData", "Data"));
            displayargs += "FoC EaW ";

            ShortcutLabel.Text = "Mod stack: " + displayargs;
        }

        private void EaWButton_Click(object sender, EventArgs e)
        {
            Args.Add(Path.Combine(UpOneFolder(UpOneFolder(localmodpath)),"GameData","Data"));
            displayargs += "EaW ";
